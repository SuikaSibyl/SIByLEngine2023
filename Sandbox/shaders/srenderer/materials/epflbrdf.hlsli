#ifndef _SRENDERER_EPFLBRDF_MATERIAL_
#define _SRENDERER_EPFLBRDF_MATERIAL_
...
StructuredBuffer<EPFLBRDFData> epfl_materials;
...
struct EpflBRDF : IBxDF {
    ...
    __init(int index) {
        EPFLBRDFData data = epfl_materials[index];
...
#endif // _SRENDERER_EPFLBRDF_MATERIAL_
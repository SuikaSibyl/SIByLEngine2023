...
path = "S:/SIByL2024/Sandbox/examples/glt/_figures"
...
gt = load_image("ref.exr")
grid = load_image("grid.exr")
splat = load_image("splat.exr")
noisy = load_image("noisy.exr")

print("MSE grid:", mse(gt, grid))
print("MSE splat:", mse(gt, splat))
print("MSE noisy:", mse(gt, noisy))

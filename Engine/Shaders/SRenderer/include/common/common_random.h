#ifndef _SRENDERER_COMMON_RANDOM_INCLUDED_
#define _SRENDERER_COMMON_RANDOM_INCLUDED_
...
#include "common_space_filling_curve.h"
#endif
...
RandomSamplerState InitRandomSampler(uvec2 pixelPos, uint frameIndex) {
...
RandomSamplerState InitRandomSampler(uvec2 index, uint frameIndex, uint pass) {

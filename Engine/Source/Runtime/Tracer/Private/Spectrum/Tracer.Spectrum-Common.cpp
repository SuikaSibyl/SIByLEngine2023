...
{
    inline auto XYZToRGB(float const xyz[3], float rgb[3]) noexcept -> void {
        rgb[0] = 3.240479f * xyz[0] - 1.537150f * xyz[1] - 0.498535f * xyz[2];
        rgb[1] = -0.969256f * xyz[0] + 1.875991f * xyz[1] + 0.041556f * xyz[2];
        rgb[2] = 0.055648f * xyz[0] - 0.204043f * xyz[1] + 1.057311f * xyz[2];
    }

    inline auto RGBToXYZ(float const rgb[3], float xyz[3]) noexcept -> void {
    ...
    float const CIE_lambda[nCIESamples] = {
    ...
    float const RGB2SpectLambda[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectWhite[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectCyan[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectMagenta[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectYellow[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectRed[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectGreen[nRGB2SpectSamples] = {
    ...
    float const RGBRefl2SpectBlue[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectWhite[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectCyan[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectMagenta[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectYellow[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectRed[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectGreen[nRGB2SpectSamples] = {
    ...
    float const RGBIllum2SpectBlue[nRGB2SpectSamples] = {

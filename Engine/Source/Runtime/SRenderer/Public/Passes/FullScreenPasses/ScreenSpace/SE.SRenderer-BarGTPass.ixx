...
export module SE.SRenderer.BarGTPass;
...
namespace SIByL::SRP
{
	export struct BarGTPass :public RDG::RayTracingPass {
	...
	export struct BarGTGraph :public RDG::Graph {
		BarGTGraph() {
	...
	export struct BarGTPipeline :public RDG::SingleGraphPipeline {

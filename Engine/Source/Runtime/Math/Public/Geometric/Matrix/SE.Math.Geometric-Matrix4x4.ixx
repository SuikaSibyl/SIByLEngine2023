...
export template <>
auto operator*(Matrix4x4<float> const& m1, Matrix4x4<float> const& m2)
    -> Matrix4x4<float> {
...
export template <>
auto operator*(Matrix4x4<float> const& m, Vector4<float> const& v)
    -> Vector4<float> {
...
template <class T>
auto Matrix4x4<T>::rotate(float theta, vec3 const& axis) noexcept
    -> Matrix4x4<T> {

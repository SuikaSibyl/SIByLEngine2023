...
{
	export inline float float_Pi = 3.14159265358979323846f;
	export inline double double_Pi = 3.14159265358979323846f;
	...
	export inline double double_InvPi = 1. / double_Pi;
	export inline double double_Inv2Pi = 1. / (2 * double_Pi);
	export inline double double_Inv4Pi = 1. / (4 * double_Pi);
	export inline double double_PiOver2 = double_Pi / 2;
	export inline double double_PiOver4 = double_Pi / 4;

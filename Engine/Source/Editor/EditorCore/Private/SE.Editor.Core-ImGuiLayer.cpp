...
ImGuiLayer::ImGuiLayer(RHI::RHILayer* rhiLayer) : rhiLayer(rhiLayer) {
  singleton = this;
  ...
  // set dark theme
  {
    ...
    colors[ImGuiCol_DockingEmptyBg] =
        ImVec4{0.117647f, 0.117647f, 0.117647f, 1.0f};
    // Headers
    ...
    colors[ImGuiCol_TitleBgActive] =
        ImVec4{0.121568f, 0.121568f, 0.121568f, 1.0f};
...
auto ImGuiLayer::startNewFrame() -> void { imguiBackend->startNewFrame(); }
...
auto ImGuiLayer::createImGuiTexture(RHI::Sampler* sampler,
